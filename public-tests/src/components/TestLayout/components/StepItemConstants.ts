 ...
 */
const BASE_STYLES = 'px-3 py-2 rounded text-sm font-medium transition-colors';

/**
 * Configuración de estilos por estado
 */
export const STEP_STYLES: Record<StepState, string> = {
  disabled: `${BASE_STYLES} bg-gray-100 text-gray-400 cursor-not-allowed border border-gray-200`,
  completed: `${BASE_STYLES} bg-green-50 text-green-700 border border-green-200 hover:bg-green-100 cursor-pointer`,
  active: `${BASE_STYLES} bg-blue-100 text-blue-800 border-2 border-blue-400 font-semibold cursor-pointer`,
  available: `${BASE_STYLES} bg-white text-gray-700 hover:bg-gray-100 border border-gray-200 cursor-pointer`
};
